...
# Recipes Project
This project serves as an example for all of the amazing things you can build with [TakeShape](https://www.takeshape.io).
...
## Credits
TakeShape! Without TakeShape this project wouldnt be possible.

favicon image: https://www.needpix.com/photo/download/755125/restaurant-eat-meal-eating-dinner-kitchen-dish-tasty-composition